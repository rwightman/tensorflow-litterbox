...
class ModelInceptionV3(object):
    ...
    @staticmethod
    def build(images, num_classes, for_training=False, restore_logits=True, scope=None):
        ...
        with scopes.arg_scope([ops.conv2d, ops.fc], weight_decay=0.00004):
            with scopes.arg_scope(
                ...
                logits, endpoints = ModelInceptionV3._build(
                    images,
        ...
        ModelInceptionV3._activation_summaries(endpoints)
    ...
    def _activation_summary(x):
        ...
        tensor_name = re.sub('%s_[0-9]*/' % ModelInceptionV3.TOWER_NAME, '', x.op.name)
    ...
    def _activation_summaries(endpoints):
        with tf.name_scope('summaries'):
            for act in endpoints.values():
                ModelInceptionV3._activation_summary(act)
