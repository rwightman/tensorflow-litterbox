...
tf.app.flags.DEFINE_string('output_graph', './output/output_graph.pb',
                           """Where to save the trained graph.""")
tf.app.flags.DEFINE_string('output_labels', './output/output_labels.txt',
                           """Where to save the trained graph's labels.""")

# Details of the training configuration.
tf.app.flags.DEFINE_integer('num_training_steps', 4000,
    ...
    if (i % FLAGS.eval_step_interval) == 0 or is_last_step:
      ...
      validation_bottlenecks, validation_ground_truth = (
          get_random_cached_bottlenecks(
              ...
              FLAGS.bottleneck_dir, FLAGS.image_dir, jpeg_data_tensor,
              bottleneck_tensor))
      validation_accuracy, validation_cross_entropy = sess.run(
          [evaluation_step, cross_entropy],
